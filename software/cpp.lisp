...
(defgeneric cpp:destructorp (ast)
  (:method ((ast t)) nil)
  (:method ((fn cpp-function-definition))
    (cpp:destructorp (definition-name-ast fn)))
  (:method ((name cpp-destructor-name))
    t)
  (:method ((name cpp-qualified-identifier))
    (cpp:destructorp (cpp-name name)))
...
(defgeneric cpp::absolute-name (ast &key source-text)
  ...
  (:method ((ast cpp-primitive-type) &key (source-text (source-text ast)))
    source-text)
  (:method ((ast cpp-sized-type-specifier) &key (source-text (source-text ast)))
    source-text)
