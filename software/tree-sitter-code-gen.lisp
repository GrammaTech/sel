  ...
  (defparameter *tree-sitter-ast-extra-slots*
    '((:c
      ...
      (:rust
       ...
       (rust-token-tree (:left-delimiter) (:right-delimiter)))
      (:javascript
    ...
    '((:c
      ...
      (:rust
       ...
       (rust-compound-assignment-expr
        ...
        (rust-right :initarg :rhs :reader rhs))
       (rust-const-block
        (rust-body :initarg :body :reader body :reader rust-body))
       (rust-const-item
  ...
  (defparameter *tree-sitter-ast-superclasses*
    '((:ada
      ...
      (:cpp
       ...
       (:arguments-ast cpp-template-argument-list))
      ((:c :cpp)
       (:c/cpp-+ c-+ cpp-+)
       (:c/cpp-- c-- cpp--)
       (:c/cpp-* c-* cpp-*)
       ...
       (:c/cpp--- c--- cpp---)
       (:boolean-operator-ast c-&& cpp-&& c-|\|\|| cpp-|\|\||)
       (:comparison-operator-ast
        c-< c-> c-== c-!= c-<= c->=
       ...
       (:c/cpp-unsigned c-unsigned cpp-unsigned)
      ...
      (:rust
       ...
       (:boolean-operator-ast rust-&& rust-|\|\||)
       (:call-ast rust-call-expression)
       (:lambda-ast rust-closure-expression)
       (:comment-ast rust-line-comment rust-block-comment)
       (:comparison-operator-ast rust-< rust-> rust-== rust-!= rust->= rust-<=)
       ...
       (:primitive-type-ast rust-primitive-type)
...
definitions.")
  ...
  (defparameter *tree-sitter-mixin-ast-superclasses*
    '((:c/cpp
       ...
       (c/cpp-conditional-expression if-expression-ast ltr-eval-ast)
       ...
       (c/cpp-preproc-call preprocessor-ast)
       ...
       (c/cpp-primitive-type primitive-type-ast)
       (c/cpp-return-statement return-statement-ast)
       (c/cpp--statement statement-ast)
       (c/cpp-sized-type-specifier primitive-type-ast)
       ...
       (c/cpp-type-definition definition-ast type-alias-ast)
...
not declarations)."))
  ...
  (defclass boolean-ast (literal-ast) ()
    (:documentation "Mix-in for AST classes that are literal booleans."))

  (defclass boolean-true-ast (boolean-ast) ()
    (:documentation "Mix-in for AST classes that are literal true booleans."))

  (defclass boolean-false-ast (boolean-ast) ()
    (:documentation "Mix-in for AST classes that are literal false booleans."))
