  ...
  (labels ((parsing-test-dir (path)
    ...
    (mapc {apply #'parse-test}
          '((#P"abstract-array-declarator.c" c-abstract-array-declarator)
            ...
            (#P"break-statement.c" c-break-statement parseable-statement)
            (#P"call-expression.c" c-call-expression)
            (#P"case-statement.c" c-case-statement parseable-statement)
            ...
            (#P"continue-statement.c" c-continue-statement parseable-statement)
            (#P"declaration.c" c-declaration)
            (#P"do-statement.c" c-do-statement parseable-statement)
            (#P"enum.c" c-enum-specifier)
            (#P"enum.c" c-enumerator)
            (#P"enum.c" c-enumerator-list)
            (#P"binary-expression.c" c-expression-statement parseable-statement)
            ...
            (#P"for-statement.c" c-for-statement parseable-statement)
            ...
            (#P"goto-statement.c" c-labeled-statement parseable-statement)
            ...
            (#P"function-definition.c" c-return-statement parseable-statement)
            ...
            (#P"case-statement.c" c-switch-statement parseable-statement)
            ...
            (#P"continue-statement.c" c-while-statement parseable-statement)))))
